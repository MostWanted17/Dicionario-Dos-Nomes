...
import namesData from '../../database/nomes_femininos_todas_paginas_ordenados.json';  // Ou o caminho correto para o seu arquivo JSON
...
function FemeninoScreen() {
  ...
  const getItemLayout = (data, index) => {
    const itemHeight = 80; // Ajuste conforme o tamanho do seu Card
...
const styles = StyleSheet.create({
  // Estilos da tela FemininoScreen
